...
try:
    ...
    error_msg = "Unable to load environment settings: " \
                "env.py is not found in settings module"
...
def get_env_setting(key, default=None):
    ...
    Absence of default value treated like value is required
    """
    try:
        if default is None:
...
# See: https://docs.djangoproject.com/en/1.6/ref/settings/#test-runner
...
SECRET_KEY = r"@3yeh_71zli9038sfvp-83mol)z=hfdez@hsfmukl3-0=*x(ev"
